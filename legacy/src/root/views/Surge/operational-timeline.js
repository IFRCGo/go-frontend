    ...
    return (
      <div className="operationalTimelineContainer">
        ...
        <div className="margin-2-t">
          ...
          <p><a href="mailto:antoine.belair@ifrc.org">antoine.belair@ifrc.org</a> {strings.operationalToolboxFooterTextList5Part5} <a href="mailto:betisa.egea@ifrc.org">betisa.egea@ifrc.org</a>.</p>
        </div>

        <div className="margin-2-t">
          <p>{strings.operationalToolboxFooterTextPer1Text} <a href="https://ifrcorg.sharepoint.com/:f:/s/IFRCSharing/EkiQndccd4ZIqMyUn983XiUBRfA14qW_CojCjibdG_Tmcw?e=My2KYE">{strings.operationalToolboxFooterTextPer2LinkText}</a>  {strings.operationalToolboxFooterTextPer3Text} </p>
