...
module.exports = function(webpackEnv) {
  ...
  if(isEnvProduction){
    //console.log(prefix);
    if(prefix === undefined){
      strpath = paths.appBuild;
    } else {
      strpath = paths.appBuild+'/' +prefix+'/';
    }
  } else {
    strpath = undefined;
  }
  ...
  const getStyleLoaders = (cssOptions, preProcessor) => {
    const loaders = [
      ...
      isEnvProduction && {
        ...
        // css is located in `assets/styles`, use '../../' to locate index.html folder
  ...
  return {
    ...
    output: {
      // The build folder.
      path: strpath,// isEnvProduction ? paths.appBuild+'/' +prefix+'/' : undefined,
      ...
      filename: isEnvProduction
        ...
        : isEnvDevelopment && 'assets/scripts/bundle.js',
      // TODO: remove this when upgrading to webpack 5
      futureEmitAssets: true,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? 'assets/scripts/[name].[contenthash:8].chunk.js'
        : isEnvDevelopment && 'assets/scripts/[name].chunk.js',
    ...
    optimization: {
      ...
      minimizer: [
        ...
        new TerserPlugin({
          // parallel = 4 for large instance of circle CI
          parallel: 4,
        }),
        // This is only used in production mode
          ...
          oneOf: [
            ...
            // A missing `test` is equivalent to a match.
            {
              ...
              options: {
                ...
                name: 'assets/scripts/media/[name].[hash:8].[ext]',
              },
            },
