export default {
  ...
  catalogueOfSurgeServicesPlanningCards1Card1Element0: 'Security Coordinator',
  catalogueOfSurgeServicesPlanningCards1Card1Element1: 'Security Officer',
  ...
  catalogueOfSurgeServicesSecurityCards1Card1BtnText: 'Security',
  ...
  catalogueOfSurgeServicesHealthCards1Card1Element4: 'Public Health Officer',
  catalogueOfSurgeServicesHealthCards1Card1Element5: 'Safe and Dignified Burials (SDB) Coordinator',
  ...
  catalogueOtherService3Text2: 'Details about the expectations for this specialty can be found in the role profiles:',
  catalogueOtherService3Text2Url1: 'Rapid Response Human Resources Coordinator role profile.',
  catalogueOtherService3Text2Url2: 'Rapid Response Human Resources Officer role profile.',
  ...
  catalogueAssesmentPersonnelComposition: 'Assessment Cell Coordinator, Info Analyst, Primary Data Collection Specialist, Secondary Data Collection Specialist (can be remote), Data Visualization Specialist.',
  ...
  catalogueBaseCampLargePersonnelComposition: 'Team Leader (Assessment), 3 Technicians, 1 ITC / Camp Manager, Technician, Kitchen Supervisor, 0-1 Cook.',
  ...
  catalogueBaseCampMediumPersonnelComposition: 'Team Leader (Assessment), 2-3 Technicians, 1 ITC / Camp Manager, Technician, Kitchen Supervisor.',
  ...
  catalogueCvaPersonnelComposition1: 'Cash Coordinator x 1 for cash feasibility, advocacy, mainstreaming cash into sectoral activities.',
  catalogueCvaPersonnelComposition2: 'Cash Officer x 1 for implementation. More Cash Officers can be deployed based on the geographical needs.',
  catalogueCvaPersonnelComposition3: 'Cash IM Officer x 1 for data management, support in reporting, visualization and decision making.',
  ...
  catalogueCommunityEngagementPersonnelComposition: 'Tier 1 Officer, and Tier 2 Coordinator.',
  ...
  catalogueCert1PersonnelComposition: '1x Communications coordinator and/or 1x AV Officer.',
  ...
  catalogueCert2PersonnelComposition: '1x Communications Coordinator or Team Leader (depending on context), 1x Communications Officer, and 1x AV Officer.',
  ...
  catalogueCert3PersonnelComposition: '1x Communications Team Leader, 1x Communications Coordinator , 1x Communications Officer, 1x AV Officer - Photographer , 1x AV Officer - Video.',
  ...
  catalogueMobileClinicPersonnelComposition: 'Deployed team includes: team leader, deputy team leader, finance, admin, logistics, doctors, nurses, technicians, PSS, public health, and others. Contracted local personnel include nurse, triage nurse, doctor, translator, midwives, cleaners, social mobilization (NS Volunteers), PSS (NS Volunteers), and others.',
  ...
  catalogueManagementCholeraPersonnelComposition: 'Team Leader, Public Health / Epidemiologist, Quality control/training x 2, WASH, Logistics, and Finance/Admin.',
  ...
  catalogueSurveillancePersonnelComposition1: 'Team lead, field epidemiologist or data/information manager. (advanced team)',
  catalogueSurveillancePersonnelComposition2: 'Team lead, field epidemiologist or data/information manager, public health, ICT and/or logistics, finance/admin. (full deployment)',
  ...
  catalogueSafeDignifiedPersonnelComposition: 'Team leader, educator/trainer, logistician, PSS, IPC/WASH, finance/admin.',
  ...
  cataloguePssModulePersonnelComposition: 'Deployed team includes one to two psychosocial support delegates. Delegates normally have a social work, nursing or psychologist background and IMPACT, ERU and PSS in emergency training.',
  ...
  catalogueItTelecomEmergencyPre: 'The details of the ',
  catalogueItTelecomEmergencyLink: 'IT&T ERU Service Catalogue are here.',
  ...
  catalogueItTelecomPersonnelComposition: '1 team leader and technicians with context-appropriate skill sets.',
  ...
  catalogueItTelecomSpecifiationNationalSocieties: 'American Red Cross, Austrian Red Cross, Finish Red Cross, New Zealand Red Cross, Spanish Red Cross.',
  ...
  catalogueLogisticsPersonnelComposition: 'Team Leader, 1-2 Supply Chain Administration delegates, AirOps delegate, 1 - 3 Warehouse/Transport delegates.',
  ...
  catalogueProtectionPersonnelComposition: 'Typically deployed team includes one to two PGI delegates. Team can be expanded based on scale of the needs.',
  ...
  catalogueReliefPersonnelComposition: '1 team leader, 1 or more field officers, 1 logistic/relief interface officer, 1 finance/relief interface officer, and 1 Relief Information Management (IM) officer (for large operations only).',
  ...
  catalogueSctPersonnelComposition: 'Shelter Coordination Team key positions include Coordinator, Information manager, Technical coordinator, and Recovery advisor.',
  ...
  catalogueSttPersonnelComposition: 'It depends on the emergency and the context. It can be 1 person or a team with several members with 3-4 different profiles.',
  ...
  catalogueM15PersonnelComposition: 'Team Leader, 1-2 WASH or Chemical Engineer, 1 Technician/Plumber, 1 Logistic/Admin/Finance',
  ...
  catalogueMsm20PersonnelComposition: 'Team Leader, 1-2 Sanitation Engineer, 1 Hygiene promoter, 1 Logistic/Admin/Finance.',
  ...
  catalogueM40PersonnelComposition: 'Team Leader, 1-2 WASH or Chemical Engineer, 1 Technician/Plumber, 1 Logistic/Admin/Finance.',
  ...
  catalogueWsrPersonnelComposition1: 'Team leader/water assessment lead',
  catalogueWsrPersonnelComposition2: 'Emergency water supply engineer (bulk/networked systems)',
  catalogueWsrPersonnelComposition3: 'Emergency water supply engineer (point/ground water sources)',
  catalogueWsrPersonnelComposition4: 'Hygiene promotor/community mobiliser (behaviour change/gender and inclusion/community engagement and accountability)',
  catalogueWsrPersonnelComposition5: 'Logistics and contracting officer',
  ...
  catalogueHwtsPersonnelComposition1: 'Team leader/HWTS assessment lead',
  catalogueHwtsPersonnelComposition2: 'Emergency water quality and treatment specialist',
  catalogueHwtsPersonnelComposition3: 'Emergency community mobilization/hygiene promotion specialist',
  catalogueHwtsPersonnelComposition4: 'Distribution specialist',
  catalogueHwtsPersonnelComposition5: 'Admin/Logs and contracting officer',
  catalogueHwtsPersonnelComposition6: 'Market assessment and Cash-based assistance specialist',
