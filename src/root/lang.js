export default {
  ...
  catalogueOfSurgeServicesTitleSubtitle1Text1: 'Disasters can have devastating impacts on individuals and communities. The frequency, complexity and severity of impacts are likely to increase in the future due to factors such as climate change, displacement, conflict, rapid and unplanned urbanization, technological hazards and public health emergencies. At the same time, contexts are becoming more complex; countries experiencing disasters associated with natural hazards may simultaneously be affected by conflict or large-scale displacement. The International Federation of Red Cross and Red Crescent Societies (IFRC) and its member National Red Cross and Red Crescent Societies strive to reduce the impact of disasters. (extracted from DRM IFRC policy)',
  ...
  catalogueOfSurgeServicesTitleSubtitle2Text1: 'The Core Competency framework for Surge Personnel is applicable to all Rapid Response personnel and is to be used as the underlying tool for an objective and transparent approach to recruitment, selection, performance management and learning and development.',
  ...
  catalogueOfSurgeServicesEmergencyCards1Card1Element1: 'Assesment Coordinator',
  ...
  catalogueOfSurgeServicesEmergencyCards1Card2BtnText: 'Assesment',  
  ...
  catalogueOfSurgeServicesEmergencyCards3Card1Title: 'Assesment and Planning',
  ...
  catalogueOfSurgeServicesPlanningCards1Card1Element1: 'PMER Coordinator',
  ...
  catalogueOfSurgeServicesSecurityCards2Card1BtnText: 'Security Management',
  ...
  catalogueOfSurgeServicesOtherCards1Card7Text: 'Supporting NS building their capacities to develop domestic fundraising portfolios, and also coordinating global initiatives when best placed to do so.',
  ...
  catalogueOfSurgeServicesHealthCards2Card5BtnText: 'Emergency Mobile Clinic',
  ...
  catalogueOfSurgeServicesHealthCards2Card11Text: '24 hour clinical services for 100-200 outpatients/day, and 1 operating theatre.',
  ...
  catalogueOtherService9Text2: 'Tiered competencies describing the knowledge and skills expected of personnel in this sector cam be found in the ',
