...
export default class CatalogueOfSurgeServicesSubPage extends React.Component {
                ...
                {content.listItems !== undefined ?
                    <ul>
                        {content.listItems.map((listItem, index) => (
                            <li key={index}>{strings[listItem]}<a href={content.listItemsUrls[index].url} onClick={e => this.openNewTab(content.listItemsUrls[index].url, e)}>{strings[content.listItemsUrls[index].text]}</a></li>
                        ))}
                    </ul>
                    : <></>
                }
                {content.text !== undefined ?
                    <p>{strings[content.text]}<a href={content.textUrl.url} onClick={e => this.openNewTab(content.textUrl.url, e)}>{strings[content.textUrl.text]}</a></p>
                    : <></>
                }
            </>
        );
        ...
        return (
            <>
                ...
                {content.listItems !== undefined ?
                    <ul>
                        {content.listItems.map((listItem, index) => (
                            <li key={index}>{strings[listItem]}</li>
                        ))}
                    </ul>
                    : <></>
                }
                ...
                {content.compositions !== undefined ?
                    <>
                        <p><strong>{strings['cataloguePersonnelSubTitle2']}</strong></p>
                        <ul>
                            {content.compositions.map((composition, index) => (
                                <li key={index}>{strings[composition]}</li>
                            ))}
                        </ul>
                    </>
                    : <></>
        ...
        return (
            <>
                ...
                {content.listItemsBoldStart !== undefined ?
                    <ul>
                        {content.listItems.map((listItem, index) => (
                            <li key={index}><strong>{strings[content.listItemsBoldStart[index]]}</strong>{strings[listItem]}</li>
                        ))}
                    </ul>
                    : content.listItems !== undefined ?
                        <ul>
    ...
    renderContentWithOrder(content, title) {
        const { strings } = this.context;
        return (
            <>
                <h3 className="margin-4-t">{title}</h3>
    ...
    renderCapacityWithUrls(content, title) {
        const { strings } = this.context;
        return (
            <>
                <h3 className="margin-4-t">{title}</h3>
                <p>
                    {content.textsWithUrlOrder.map((order, index) => (
                        <span key={index}>{strings[content.texts[order.text]]}
                            <a href={content.urls[order.url].url} onClick={e => this.openNewTab(content.urls[order.url].url, e)}>{strings[content.urls[order.url].text]}</a>
                        </span>
                    ))}
                </p>
            </>
        ...
        return (
            <div className="catalogueServicePage">
                ...
                {content.textSection.capacity !== undefined ?
                    content.textSection.capacity.textsWithUrlOrder !== undefined ?
                        this.renderCapacityWithUrls(content.textSection.capacity, strings['catalogueCapcityTitle'])
                ...
                {content.textSection.emergencyServices !== undefined ?
                    content.textSection.emergencyServices.textsOrder !== undefined ?
                        this.renderContentWithOrder(content.textSection.emergencyServices, strings['catalogueEmergencyTitle'])
                ...
                {content.textSection.designedFor !== undefined ?
                    content.textSection.designedFor.textsOrder !== undefined ?
                        this.renderContentWithOrder(content.textSection.designedFor, strings['catalogueDesignedTitle'])
                        : this.renderContent(content.textSection.designedFor, strings['catalogueDesignedTitle'])
                    : <></>
                }
                {content.textSection.personnel !== undefined ?
                    this.renderContentPersonnel(content.textSection.personnel, strings['cataloguePersonnelTitle'])
                    : <></>
                }
...
const data = [
    ...
    },
    {
        ...
        textSection: {
            ...
            personnel: {
                text: 'catalogueLivelihoodsPersonnelText',
                listItems: [
