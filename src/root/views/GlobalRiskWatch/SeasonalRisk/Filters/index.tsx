...
import { RiskMetricType,
  riskMetricOptions,
  RiskType,
  riskTypeOptions,
  monthKeys,
  monthOptions,
  seasonalHazardTypeToNameMap,
  informHazards,
  exposureHazards,
  displacementHazards,
  MonthKey,
...
export interface FilterValue {
  countries: string[];
  hazardTypes: SeasonalHazardTypes[];
  riskType: RiskType;
...
const defaultHazardTypeByMetric: Record<RiskMetricType, SeasonalHazardTypes[]> = {
  ...
  const hazardTypeOptions = React.useMemo(() => {
    if (value.riskMetric === 'informRiskScore') {
      return informHazards.map((h) => ({
        value: h,
        label: seasonalHazardTypeToNameMap[h],
      }));
    }
  ...
  return (
    <div className={_cs(styles.filters, className)}>
      <div className={styles.inputs}>
        ...
        />
        <SelectInput<'hazardTypes', SeasonalHazardTypes>
          className={styles.filterInput}
      ...
      <div className={styles.outputs}>
        <FilterOutput<'countries', string, (typeof countryOptions)[number]> 
          ...
          isMulti
        />
        <FilterOutput<'hazardTypes', SeasonalHazardTypes, (typeof hazardTypeOptions)[number]> 
          label="Hazard Types:"
          name={"hazardTypes" as const}
          options={hazardTypeOptions}
          value={value.hazardTypes}
