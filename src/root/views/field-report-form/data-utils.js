...
export function dataPathToDisplay (path, keyword) {
  ...
  const index = {
    ...
    'numPotentiallyAffected.estimation': 'Estimation Potentially Affected',
    'numPotentiallyAffected.source': 'Source Potentially Affected',
    'numHighestRisk.estimation': 'Estimation Highest Risk',
