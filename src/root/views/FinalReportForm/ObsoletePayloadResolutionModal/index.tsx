...
import { DrefFinalReportApiFields } from '../common';

import styles from './styles.module.scss';

function getUserName(user: DrefFinalReportApiFields['modified_by_details'] | undefined) {
  if (!user) {
    return 'Unknown User';
  }
  ...
  return (
    ...
    >
      ...
      {!drefPending && (
        <>
          <div>
            There's a newer version of current Final Report which was modified by &nbsp;
            <strong>
          ...
          <div>
            ...
            &nbsp;You can open this Final Report form in a new tab and verify / merge the changes manually.
          </div>
        </>
      )}
    </Modal>
