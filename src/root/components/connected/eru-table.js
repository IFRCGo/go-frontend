...
class EruTable extends SFPComponent {
  ...
  render () {
    ...
    if (fetched) {
      ...
      return (
        <Fold title={`${title} (${n(data.count)})`} id={this.props.id} foldWrapperClass='table__container container--padding-reset' navLink={foldLink} foldTitleClass='fold__title--inline'>
