        ...
        <div className={c('nav__block', {
          ...
          <div className='inner container-lg'>
            ...
            <ul className='nav-block-menu'>
              ...
              <li><Link to='/three-w/' title={strings.mobileHeaderVisitThreeW} className={c({'disabled': pathname === '/deployments'})}><span><Translate stringId='mobileHeaderThreeW'/></span></Link></li>
